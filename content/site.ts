export const siteConfig = {
  ...
  nav: [
    { label: "關於我", subtitle: "About Me", href: "#about" },
    { label: "攝影作品", subtitle: "Photography", href: "#portfolio" },
    { label: "服務項目", subtitle: "Services", href: "#services" },
    { label: "預約服務", subtitle: "Booking", href: "#contact" }
  ]
} as const;
